...
interface BodyworkManufacturer {
  id: string;
  name: string;
  country: string | null;
  website: string | null;
...
export default function BodyworkManufacturersManagement() {
  const [manufacturers, setManufacturers] = useState<BodyworkManufacturer[]>([]);
  const [loading, setLoading] = useState(true);
  const [isDialogOpen, setIsDialogOpen] = useState(false);
  const [editingManufacturer, setEditingManufacturer] = useState<BodyworkManufacturer | null>(null);
  ...
  const handleOpenDialog = (manufacturer?: BodyworkManufacturer) => {
    if (manufacturer) {
      ...
      <Card>
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              <CardTitle>Fabricantes de Carroceria</CardTitle>
              <CardDescription>
                Gerencie os fabricantes de carroceria (Busscar, Marcopolo, Caio, etc.)
              </CardDescription>
            </div>
            ...
            <div className="space-y-4 py-4">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  placeholder="Ex: Busscar, Marcopolo, Caio"
                  required
                />
              </div>
